...
(function (jQCalendar, $, undefined) {
    jQCalendar.init = function (obj, embeded) {
        let calendarObj = $(obj);
        let wrapperId = calendarObj.attr('id');
        let inputControlId = wrapperId + 'inputControl';
        let selectedDateRangeId = wrapperId + 'selectedDateRange';
        ...
        calendarObj.dateRangePicker(
            {
                ...
                format: 'MMM DD, YYYY',
                separator: ' - ',
                startDate: moment('2015-04-20').toDate(), // this is a specific first date
        ...
        $('.date-picker-wrapper .yesterday').on('click', function (e) {
            e.stopPropagation();
            let startDate = calendarObj.data('dateRangePicker').getFirstDate();
            if (startDate && moment(startDate).isSameOrAfter(moment()))
                return false;
            startDate = moment().subtract({ Days: 1 }).toDate();
            let endDate = moment().subtract({ Days: 1 }).toDate();
        ...
        $('.date-picker-wrapper .lastSevenDays').on('click', function (e) {
            ...
            let startDate = getValidStartDate(moment().subtract({ Days: 7 }).toDate());
            let endDate = moment().subtract({ Days: 1 }).toDate();
            startDate.setTime(startDate);
            endDate.setTime(endDate);
            calendarObj.data('dateRangePicker').setDateRange(startDate, endDate);
        ...
        $('.date-picker-wrapper .lastThirtyDays').on('click', function (e) {
            e.stopPropagation();
            calendarObj.data('dateRangePicker').setRangePreselectedFlag();
            let startDate = getValidStartDate(moment().subtract({ Days: 30 }).toDate());
            let endDate = moment().subtract({ Days: 1 }).toDate();
            startDate.setTime(startDate);
            endDate.setTime(endDate);
            calendarObj.data('dateRangePicker').setDateRange(startDate, endDate);
        ...
        $('.date-picker-wrapper .lastWeek').on('click', function (e) {
            e.stopPropagation();
            calendarObj.data('dateRangePicker').setRangePreselectedFlag();
            let startDate = getValidStartDate(moment().add({ weeks: -1 }).startOf('week').toDate());
            let endDate = moment().add({ weeks: -1 }).endOf('week').toDate();
            startDate.setTime(startDate);
            endDate.setTime(endDate);
            calendarObj.data('dateRangePicker').setDateRange(startDate, endDate);
        ...
        $('.date-picker-wrapper .thisWeek').on('click', function (e) {
            e.stopPropagation();
            calendarObj.data('dateRangePicker').setRangePreselectedFlag();
            let startDate = getValidStartDate(moment().startOf('week').toDate());
            let endDate = getValidEndDate(moment().toDate());
            startDate.setTime(startDate);
            endDate.setTime(endDate);
            calendarObj.data('dateRangePicker').setDateRange(startDate, endDate);
            calendarObj.data('dateRangePicker').setRangeSelectedType({ Weeks: 1 });
        ...
        $('.date-picker-wrapper .lastMonth').on('click', function (e) {
            e.stopPropagation();
            calendarObj.data('dateRangePicker').setRangePreselectedFlag();
            let startDate = getValidStartDate(moment().add({ month: -1 }).startOf('month').toDate());
            let endDate = moment().add({ month: -1 }).endOf('month').toDate();
            startDate.setTime(startDate);
            endDate.setTime(endDate);
            calendarObj.data('dateRangePicker').setDateRange(startDate, endDate);
        ...
        $('.date-picker-wrapper .thisMonth').on('click', function (e) {
            e.stopPropagation();
            calendarObj.data('dateRangePicker').setRangePreselectedFlag();
            let startDate = getValidStartDate(moment().startOf('month').toDate());
            let endDate = getValidEndDate(moment().toDate());
            startDate.setTime(startDate);
            endDate.setTime(endDate);
            calendarObj.data('dateRangePicker').setDateRange(startDate, endDate);
        ...
        $('.date-picker-wrapper .lastQuarter').on('click', function (e) {
            e.stopPropagation();
            calendarObj.data('dateRangePicker').setRangePreselectedFlag();
            let startDate = getValidStartDate(moment().add({ quarter: -1 }).startOf('quarter').toDate());
            let endDate = moment().add({ quarter: -1 }).endOf('quarter').toDate();
            startDate.setTime(startDate);
            endDate.setTime(endDate);
            calendarObj.data('dateRangePicker').setDateRange(startDate, endDate);
        ...
        $('.date-picker-wrapper .thisQuarter').on('click', function (e) {
            e.stopPropagation();
            calendarObj.data('dateRangePicker').setRangePreselectedFlag();
            let startDate = getValidStartDate(moment().startOf('quarter').toDate());
            let endDate = getValidEndDate(moment().toDate());
            startDate.setTime(startDate);
            endDate.setTime(endDate);
            calendarObj.data('dateRangePicker').setDateRange(startDate, endDate);
        ...
        $('.date-picker-wrapper .lastYear').on('click', function (e) {
            ...
            let endDate = moment().add({ year: -1 }).endOf('year').toDate();
            startDate.setTime(startDate);
            endDate.setTime(endDate);
            calendarObj.data('dateRangePicker').setDateRange(startDate, endDate);
        ...
        $('.date-picker-wrapper .thisYear').on('click', function (e) {
            e.stopPropagation();
            calendarObj.data('dateRangePicker').setRangePreselectedFlag();
            let startDate = getValidStartDate(moment().startOf('year').toDate());
            let endDate = getValidEndDate(moment().toDate());
            startDate.setTime(startDate);
            endDate.setTime(endDate);
            calendarObj.data('dateRangePicker').setDateRange(startDate, endDate);
        ...
        $('.date-picker-wrapper .allAvailableDates').on('click', function (e) {
            ...
            calendarObj.data('dateRangePicker').setRangePreselectedFlag();
            let startDate = moment(calendarObj.data('dateRangePicker').getFirstDate()).toDate();
            let endDate = calendarObj.data('dateRangePicker').getAllowCurrentDate() === false ? moment().subtract({ Days: 1 }).toDate() : moment().toDate();
            startDate.setTime(startDate);
            endDate.setTime(endDate);
            calendarObj.data('dateRangePicker').setDateRange(startDate, endDate);
        });
        ...
        $('.calendar-wrapper .prevBtn').on('click', function (e) {
            ...
            let dateDiff = datePicker.getRangeSelectedType();
            if (!dateDiff)
                dateDiff = { Days: 1 };
        ...
        $('.calendar-wrapper .nextBtn').on('click', function (e) {
            e.stopPropagation();
            let datePicker = calendarObj.data('dateRangePicker');
        ...
        function getValidStartDate(expectedStartDate) {
            let datePicker = calendarObj.data('dateRangePicker');
            let startDate = datePicker.getFirstDate();
