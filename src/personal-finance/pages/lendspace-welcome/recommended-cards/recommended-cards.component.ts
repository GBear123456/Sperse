...
import { OfferDto, OfferDtoSystemType, OfferDtoOfferCollection } from '@shared/service-proxies/service-proxies';
...
export class RecommendedCardsComponent implements OnInit {
    recommendedCards: OfferDto[] = new Array<OfferDto>(
        new OfferDto({
            ...
            introRewardsBonus: undefined,
            regularAPR: undefined,
            offerCollection: OfferDtoOfferCollection.ZeroPercentageOnPurchases
        }),
        new OfferDto({
            campaignId: 2664,
            ...
            introRewardsBonus: undefined,
            regularAPR: undefined,
            offerCollection: OfferDtoOfferCollection.NoAnnualFees
        }),
        new OfferDto({
            campaignId: 2666,
            ...
            introRewardsBonus: undefined,
            regularAPR: undefined,
            offerCollection: OfferDtoOfferCollection.SecuredOrPrepaid
        }),
        new OfferDto({
            campaignId: 2655,
            ...
            introRewardsBonus: undefined,
            regularAPR: undefined,
            offerCollection: OfferDtoOfferCollection.RewardPoints
        })
    );
    discoverData: OfferDto = new OfferDto({
        campaignId: 2785,
        systemType: OfferDtoSystemType.EPCVIP,
