...
export class HeadLineComponent implements OnInit, OnDestroy {
    ...
    switchNavBar() {
        this.settingsProxy.getAppearanceSettings()
            .pipe(switchMap(settings => {
                ...
                return this.settingsProxy.updateAppearanceSettings(
                    new AppearanceSettingsEditDto({
                        navPosition: settings.appearanceSettings.navPosition,
                        navBackground: settings.appearanceSettings.navBackground,
                        navTextColor: settings.appearanceSettings.navTextColor,
                        buttonColor: settings.appearanceSettings.buttonColor,
                        buttonTextColor: settings.appearanceSettings.buttonTextColor,
                        buttonHighlightedColor: settings.appearanceSettings.buttonHighlightedColor,
                        fontName: settings.appearanceSettings.fontName,
                        borderRadius: settings.appearanceSettings.borderRadius,
                        welcomePageAppearance: settings.appearanceSettings.welcomePageAppearance,
                        tabularFont: settings.appearanceSettings.tabularFont,
                        leftsideMenuColor: settings.appearanceSettings.leftsideMenuColor,
