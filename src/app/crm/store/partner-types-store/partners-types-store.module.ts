...
import { PartnerTypesStoreEffects } from '@app/crm/store/partner-types-store/effects';
import { partnerTypesReducer } from '@app/crm/store/partner-types-store/reducer';
