...
import { CustomerListInfoDto, CustomerListInput } from '@shared/service-proxies/service-proxies';
...
export enum ActionTypes {
    ...
    ADD_LIST_SUCCESS    = '[Lists] Add list successfuly',
    ADD_LIST_FAILUTE    = '[Lists] Add list with failure',
    RENAME_LIST         = '[Lists] Rename list',
    RENAME_LIST_SUCCESS = '[Lists] Rename list successfuly',
    RENAME_LIST_FAILURE = '[Lists] Rename list fauilure',
...
export class LoadSuccessAction implements Action {
    ...
    constructor(public payload: CustomerListInfoDto[]) {}
}
