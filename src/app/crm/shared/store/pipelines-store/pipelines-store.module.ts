...
import { PipelinesStoreEffects } from '@app/crm/shared/store/pipelines-store/effects';
import { pipelinesReducer } from '@app/crm/shared/store/pipelines-store/reducer';
