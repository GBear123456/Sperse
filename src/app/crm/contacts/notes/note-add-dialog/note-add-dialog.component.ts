...
export class NoteAddDialogComponent extends AppComponentBase implements OnInit, AfterViewInit {
    ...
    constructor(
        ...
        if (this.data.contactInfo['organizationContactInfo'] && this.data.contactInfo['organizationContactInfo'].contactPersons) {
            let orgContact = <any>this._contactInfo['organizationContactInfo'],
                contacts = this._contactInfo['organizationContactInfo'].contactPersons.length ? this._contactInfo['organizationContactInfo'].contactPersons : [this._contactInfo.personContactInfo];
