...
import { InvoiceServiceProxy, AddBankCardPaymentInput, InvoiceSettings, PaymentTransactionType, PaymentServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class MarkAsPaidDialogComponent {
    ...
    currency = '$';
    transactionTypes = [PaymentTransactionType.Sale, PaymentTransactionType.Refund, PaymentTransactionType.Chargeback];
    ...
    constructor(
        ...
        this.model.invoiceId = this.data.invoice.InvoiceId;
        this.model.invoiceNumber = this.data.invoice.InvoiceNumber;
        this.model.orderStage = this.data.invoice.OrderStage;
        this.model.transactionType = this.transactionTypes[0];
    }
