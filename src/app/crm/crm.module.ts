...
import { LucideAngularModule, House, Users, TrendingUp, ChartColumn, Globe, Search, Filter, MapPin, FileText, Wifi, DollarSign, Target, User, Crosshair, Clock, BarChart3, Crown, Star, Zap, Award, BadgeDollarSign, MessageSquare, LogIn, UserCheck, Calendar, Copy, Megaphone, Radio, Tag, Smartphone, Globe2, File, History, GlobeLock, Eye, MousePointer, Network, MapPinCheck, Navigation, Laptop, Monitor, Languages, Server, Settings, ExternalLink, MoveLeft, MoveRight, ArrowLeft, ArrowRight } from 'lucide-angular';
