...
import { PersonContactInfoDto, CustomerInfoDto, SimilarCustomerInfo } from 'shared/service-proxies/service-proxies';
...
export class SimilarCustomersDialogComponent extends AppComponentBase {
    ...
    selectSimilarCustomer(similarCustomer: SimilarCustomerInfo): void {
