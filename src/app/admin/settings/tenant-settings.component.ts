...
import {
    ...
    IdcsSettings, BaseCommercePaymentSettings, TenantSettingsCreditReportServiceProxy, TenantPaymentSettingsServiceProxy, RecurlyPaymentSettings
    ...
    getSettings(): void {
        ...
        forkJoin(requests)
            ...
            .subscribe((result) => {
                ...
                this.recurlySettings = result[2];

                if (this.isCreditReportFeatureEnabled)
                    this.idcsSettings = result[3];
            });
    }
