        ...
        },
        {
            ...
            visible: this.appSessionService.tenant
                     && this.appSessionService.tenant.customLayoutType == LayoutType.AdvicePeriod
                        ? false
                        : this._cfoService.hasCategorizationSupported && this._cfoService.accessAllDepartments
        },
        {
            caption: 'Permissions',
            component: '/permissions',
            visible: this.isInstanceAdmin && this.instanceType == InstanceType.Main,
            isAlwaysActive: false
        },
        {
            caption: 'InvitedUsers',
            component: '/users',
            visible: this._cfoService.instanceId && this._cfoService.isMemberAccessManage
        }
    ];
