...
import { SyncAccountServiceProxy, InstanceType95 } from '@shared/service-proxies/service-proxies';
...
export class BankAccountsGeneralComponent extends CFOComponentBase implements OnInit, AfterViewInit  {
    ...
    constructor(
        ...
        this._syncAccountServiceProxy.createIsAllowed(this._cfoService.instanceType as InstanceType95, this.instanceId)
            .subscribe((result) => {
