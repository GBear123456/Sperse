...
import { PartnerServiceProxy, PartnerTypeServiceProxy, DictionaryServiceProxy } from '@shared/service-proxies/service-proxies';
...
@NgModule({
    ...
    providers: [PartnerTypesStoreEffects, PartnerServiceProxy, PartnerTypeServiceProxy, DictionaryServiceProxy ]
})
