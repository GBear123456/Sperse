...
export class XeroLoginComponent {
    ...
    connectToXero(e) {
        ...
        this._syncAccountServiceProxy.create(
            this._cfoService.instanceType as InstanceType91,
    ...
    updateSyncAccount() {
        ...
        this._syncAccountServiceProxy.update(this._cfoService.instanceType as InstanceType92, this._cfoService.instanceId,
