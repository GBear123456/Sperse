...
namespace Sperse.CRM.EntityFramework.Repositories
{
    /// <summary>
    ...
    public abstract class CRMRepositoryBase<TEntity, TPrimaryKey> : EfRepositoryBase<CRMDbContext, TEntity, TPrimaryKey>
